// components/comum/AvatarGrid.jsx
import PropTypes from 'prop-types';
import { ImgAvatar } from './imagemAvatar';

export function AvatarGrid({ avatares, avatarSelecionado, selecionarAvatar }) {
    return (
      <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-4 mt-2">
        {avatares.map((avatar, index) => (
          ...
          >
            <div className={`w-26 h-26 rounded-full border-2 p-1 flex ${
